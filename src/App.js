...
const App = () => {
  ...
  const { loading: authLoading, error: authError } = useContext(AuthContext) || {};
  const { loading: cartLoading, error: cartError } = useContext(CartContext) || {};
  ...
  const error = authError || cartError;
